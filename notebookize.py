...
def get_function_source_and_def_index(
    func: Callable[..., Any],
) -> Tuple[List[str], int]:
    """
...
def watch_notebook_for_changes(
    notebook_path: Path, source_file: str, func_name: str, logger: logging.Logger
) -> None:
...
def notebookize(
    func: Optional[F] = None, *, open_jupyterlab: bool = True
